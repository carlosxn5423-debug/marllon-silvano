export const content = {
  professional: {
    ...
    photoAbout2: "/images/about-ambiente.png",
  ...
  about: {
    ...
    paragraphs: [
      "São 12 anos de vendas dos mais diversos produtos, além de 5 anos com experiência em vendas jurídicas. Sou Formado em Direito pela UniBrasil e pós-graduado em Gestão Comercial e Vendas. Antes de ser o responsável pelo Comercial de escritórios de advocacia, sou pai, e é dessa base que veio o propósito: devolver tempo e previsibilidade para advogados que escolheram o direito, não a operação de vendas.",
